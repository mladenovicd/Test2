...
for(let i =0; i < 8;i++){
    ...
    if(i==0){
        option.value = 'Scipionyx'
        option.textContent = 'Scipionyx'
    }
    if(i==1){
        option.value = 'Sciurumimus'
        option.textCoontent = 'Sciurumimus'
    }
    if(i==2){
        option.value = 'Hypsilophodon'
        option.textContent = 'Hypsilophodon'
    }
    if(i==3){
        option.value = 'Dacentrurus'
        option.textContent = 'Dacentrurus'
    }
    if(i==4){
        option.value = 'Iguanodon'
        option.textContent = 'Iguanodon'
    }
    if(i==5){
        option.value = 'Asylosaurus'
        option.textContent ='Asylosaurus'
    }
    if(i==6){
        option.value = 'Efraasia'
        option.textContent = 'Efraasia'
    }
    if(i==7){
        option.value = 'Cryptosaurus'
        option.textContent = 'Cryptosaurus'
    }
